...
require_once(dirname(__file__) . '/BorhanSecretRepository.php');
...
class BorhanSession
{
	...
	{
		$adminSecret = BorhanSecretRepository::getAdminSecret($this->partner_id);
		if (!$adminSecret)
			return null;
	...
	{
		BorhanSession::$secretRepositories[] = $repo;
	}
	...
	public function parseKsV1($encoded_str)
	{
		...
		$salt = BorhanSecretRepository::getAdminSecret($partnerId);
		if (!$salt)
		{
