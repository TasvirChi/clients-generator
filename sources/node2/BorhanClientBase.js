...
const borhan = require('./BorhanRequestData');
 ...
 * 
 */
class ClientBase extends borhan.RequestData {
...
class RequestBuilder extends borhan.VolatileRequestData {
		...
		var request = http.request(options, function(response) {
			...
			response.on('end', function() {
				...
				for ( var header in response.headers) {
					...
					else if(header === 'x-borhan-session') {
