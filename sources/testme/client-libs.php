...
<head>
	<title>Borhan - API v3 SDK - Client Libraries</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="Description" content="The Borhan API SDK is a set of automatically generated API Client Libraries in native programming languages that simplifies development of applications that leverage the Borhan Platform API" />
	<meta name="Keywords" content="Borhan,Borhan API,API,SDK,Client Libraries,client library,code library,library,video,testme" />
	<meta name="author" content="Borhan Inc." />
...
?>
	...
	?>
		<div id="content">
			<div id="header">
				<h1>Borhan API SDK - Native Client Libraries</h1>
				<p>When developing applications that interact with the Borhan API, it is best to use a native Client Library.</p>
				<p style="margin-bottom:5px;">Below you can download the Client Library for the programming language of your choice.</p>
				<p>Please note, the client libraries provided here have been generated for the Borhan.com SaaS API.<br />
				Users of self-hosted editions of Borhan (On-Prem or CE) are encouraged to use their Borhan Server Clients Generator for optimal compatibility.</p>
			...
			<div id="boxs">
				...
				<div id="notifications-box">
					<div id="notifications-header">
						...
						<p style="margin-top:4px;">Tweet - <a class="bluelink" target="_blank" href="http://twitter.com/?status=@Borhan_API%20pls%20add%20sdk%20for%3A%20%5Bprogramming_language%5D" title="Tweet for a new client library">@Borhan_API pls add sdk for: [lang]</a>.<br />
						Or <a class="bluelink" target="_blank" href="http://www.borhan.org/api-client-library-generator-guide" title="Creating a client library generator script">create your own Client Library Generator</a>.</p>
					</div>
					<div class="twitter-icon-div">
						<a href="http://twitter.com/Borhan_API" target="_blank" title="Follow @Borhan_API to get updates about changes and new additions to the API and Client Libraries (SDK)."><img class="twitter-icon" src="./images/twitter-icon.png" /></a>
						<span class="graytext">Follow <a href="http://twitter.com/Borhan_API" target="_blank" title="Follow @Borhan_API to get updates about changes and new additions to the API and Client Libraries (SDK).">@borhan_api</a> for updates</span>
					</div>
				</div>
				<div class="clear"></div>
			</div>
			<p class="graytext">To help developers leverage the Borhan APIs in their own native programming language,<br />
Borhan has created a mechanism that automatically generates up-to-date software development kits in various languages.<br />
