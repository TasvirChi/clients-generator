...
abstract public class BorhanClientBase implements Serializable {
	...
	public void queueServiceCall(String service, String action, BorhanParams kparams, Class<?> expectedClass) throws BorhanApiException {
		this.queueServiceCall(service, action, kparams, new BorhanFiles(), expectedClass);
	}
	
	public void queueServiceCall(String service, String action, BorhanParams kparams, BorhanFiles kfiles) throws BorhanApiException {
		this.queueServiceCall(service, action, kparams, kfiles, null);
	}

	public void queueServiceCall(String service, String action, BorhanParams kparams, BorhanFiles kfiles, Class<?> expectedClass) throws BorhanApiException {
		Object value;
	...
	private PostMethod createPostMethod(BorhanParams kparams, BorhanFiles kfiles, String url) throws UnsupportedEncodingException {
	...
	public void mapMultiRequestParam(int resultNumber, int requestNumber, String requestParamName) throws BorhanApiException {
		this.mapMultiRequestParam(resultNumber, null, requestNumber, requestParamName);
	}

	public void mapMultiRequestParam(int resultNumber, String resultParamName, int requestNumber, String requestParamName) throws BorhanApiException {
