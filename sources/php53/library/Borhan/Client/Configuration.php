...
class Configuration
{
	 ...
	 * @var string
	 */
	private $serviceUrl    				= "http://www.borhan.com/";
	
	/**
	 * @var int
	 */
	private $format        				= Client::BORHAN_SERVICE_FORMAT_XML;
	 ...
	 *
	 * @param \Borhan\Client\ILogger $log
	 */
