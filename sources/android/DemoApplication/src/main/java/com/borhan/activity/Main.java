...
import com.borhan.services.UploadToken;
            ...
            try {
                if (Utils.checkInternetConnection(getApplicationContext())) {
                    ...
                    if (pathfromURI != null && category != null && title != null && description != null && tags != null) {
                        ...
                        BorhanMediaEntry newEntry = Media.addEmptyEntry(TAG, category, title, description, tags);
    ...
    private class DownloadListCatigoriesTask extends AsyncTask<Void, States, Void> {
        ...
        protected void onPostExecute(Void param) {
            ...
            if (listCategory != null) {
                ...
                for (BorhanCategory list : listCategory) {
                    ls.add(list.name);
                }
