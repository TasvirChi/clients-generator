...
public class BoxAdapterRate extends BaseAdapter {
    ...
    private List<BorhanFlavorAsset> list;
    ...
    public BoxAdapterRate(Context context, List<BorhanFlavorAsset> list, int backgroundColor) {
        ...
        if (list != null) {
            ...
            this.list = new ArrayList<BorhanFlavorAsset>();
        }
    ...
    public StringBuffer getFlavorBitrate(int position) {
    	BorhanFlavorAsset flavor = getFlavor(position);
    ...
    public BorhanFlavorAsset getFlavor(int position) {
