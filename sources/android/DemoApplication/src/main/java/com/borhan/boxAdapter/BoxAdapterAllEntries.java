...
public class BoxAdapterAllEntries extends BaseAdapter {
    ...
    private List<BorhanMediaEntry> list;
    private HashMap<BorhanMediaEntry, Bitmap> listThumbanil;
    private LayoutInflater lInflater;
    private Typeface typeFont;
    private int width;
    private int height;

    public BoxAdapterAllEntries(Context context, int width, int height, List<BorhanMediaEntry> list, HashMap<BorhanMediaEntry, Bitmap> listThumbanil) {
        this.width = width;
        this.height = height;
        /**
         * Set type font
        ...
        if (list != null) {
            ...
            this.list = new ArrayList<BorhanMediaEntry>();
            this.listThumbanil = new HashMap<BorhanMediaEntry, Bitmap>();
        }
