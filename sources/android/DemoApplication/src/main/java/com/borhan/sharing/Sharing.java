...
public class Sharing {
    ...
    public void sendToFacebook(final BorhanMediaEntry entry) {
    ...
    public void sendToTwitter(final BorhanMediaEntry entry) {
    ...
    public void sendToMail(BorhanMediaEntry entry) {
