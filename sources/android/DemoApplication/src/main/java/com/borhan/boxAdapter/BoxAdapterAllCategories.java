...
public class BoxAdapterAllCategories extends BaseAdapter {
    ...
    private List<BorhanCategory> list;
    ...
    public BoxAdapterAllCategories(Context context, List<BorhanCategory> list, int textColor, int arrow, int backgroundColor) {
        ...
        if (list != null) {
            ...
            this.list = new ArrayList<BorhanCategory>();
        }
