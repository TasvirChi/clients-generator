...
import com.borhan.client.BorhanLoggerAndroid;

abstract public class BorhanLogger implements IBorhanLogger
{
	// Creation & retrieval methods:
	public static BorhanLogger getLogger(String name)
	{
		return BorhanLoggerAndroid.getLogger(name);
	}
	
	public static BorhanLogger getLogger(Class<?> clazz)
	{
