...
namespace Borhan.Request
{
    public class Params : SortedList<string, ISerializable>, ISerializable
    {
        ...
        public void Add(string key, ObjectBase borhanObject)
        {
            Params objectProperties = borhanObject.ToParams();
            Add(key, objectProperties);
        }

        public void AddIfNotNull(string key, ObjectBase borhanObject)
        {
