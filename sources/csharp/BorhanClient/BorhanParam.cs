...
namespace Borhan
{
    public class BorhanParam : IBorhanSerializable
    {
        ...
        public BorhanParam(string value)
        {
            _Value = value;
            _ParamType = PARAM_TYPE_STRING;
        }
        public BorhanParam(bool value)
        {
            _BoolValue = value;
            _ParamType = PARAM_TYPE_BOOL;
        }
        public BorhanParam(long value)
        {
            _LongValue = value;
            _ParamType = PARAM_TYPE_LONG;
        }
        public BorhanParam(int value)
        {
            _IntValue = value;
            _ParamType = PARAM_TYPE_INT;
        }
        public BorhanParam(float value)
        {
            _FloatValue = value;
