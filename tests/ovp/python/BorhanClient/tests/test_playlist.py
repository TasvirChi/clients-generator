...
from BorhanClient.Plugins.Core import BorhanPlaylist, BorhanPlaylistType
from BorhanClient.Plugins.Core import BorhanPlaylistListResponse

class PlaylistTests(BorhanBaseTest):
    ...
    def test_list(self):
        ...
        self.assertIsInstance(resp, BorhanPlaylistListResponse)
                
        objs = resp.objects
        self.assertIsInstance(objs, list)
        
        [self.assertIsInstance(o, BorhanPlaylist) for o in objs] 
        
    def test_createRemote(self):
        kplaylist = BorhanPlaylist()
        kplaylist.setName('pytest.PlaylistTests.test_createRemote')
        kplaylist.setPlaylistType(BorhanPlaylistType(BorhanPlaylistType.STATIC_LIST)) #??? STATIC LIST ???
        
        kplaylist = self.client.playlist.add(kplaylist)        
        self.assertIsInstance(kplaylist, BorhanPlaylist)
    ...
    def test_update(self):
        ...
        kplaylist.setPlaylistType(BorhanPlaylistType(BorhanPlaylistType.STATIC_LIST))
        kplaylist = self.client.playlist.add(kplaylist)        
        self.addCleanup(self.client.playlist.delete, kplaylist.getId())

        newPlaylist = BorhanPlaylist()        
    ...
    def test_updateStaticContent(self):        
        ...
        mediaEntry1 = BorhanMediaEntry()
        mediaEntry1.setName('pytest.PlaylistTests.test_updateStaticContent1')
        mediaEntry1.setMediaType(BorhanMediaType(BorhanMediaType.VIDEO))
        ...
        mediaEntry2 = BorhanMediaEntry()
        mediaEntry2.setName('pytest.PlaylistTests.test_updateStaticContent2')
        mediaEntry2.setMediaType(BorhanMediaType(BorhanMediaType.VIDEO))
        ulFile = getTestFile('DemoVideo.flv')
        uploadTokenId = self.client.media.upload(ulFile) 
    ...
    def test_updateExceptionReferenceIdNotSet(self):
        from BorhanClient.Base import BorhanException
        ...
        self.assertRaises(BorhanException, self.client.playlist.update, playlistId, playlist) 
    
class DynamicPlaylistTests(BorhanBaseTest):
    
    def test_createRemote(self):
        kplaylist = BorhanPlaylist()
        kplaylist.setName('pytest.PlaylistTests.test_createRemote')
        kplaylist.setPlaylistType(BorhanPlaylistType(BorhanPlaylistType.DYNAMIC))
    ...
    #def test_createTagRule(self):
        #from BorhanClient.Plugins.Core import BorhanMediaEntry, BorhanMediaType
        #from BorhanClient.Plugins.Core import BorhanMediaEntryFilterForPlaylist
        ...
        #playlistFilter = BorhanMediaEntryFilterForPlaylist()
    ...
    #def test_createSingleCategoryRule(self):
        #from BorhanClient.Plugins.Core import BorhanMediaEntry, BorhanMediaType
        #from BorhanClient.Plugins.Core import BorhanPlaylistFilter
    ...
    #def test_EditAncestorCategoryRule(self):
        ...
        #new_kFilter = BorhanPlaylistFilter()
        #new_kFilter.setCategoryAncestorIdIn(subCategory2.getId())
        #new_kplaylist = BorhanPlaylist()
